...
#include <iostream>                     // not sure about this                                
#include <SFML/Graphics.hpp>
#include <time.h>						// not sure about this too
using namespace sf;
...
int main()
{
	...
	Texture t1, t2, t3;	// image file locaters
	t1.loadFromFile("images/tiles.png");
	t2.loadFromFile("images/background.png"); // maybe change a bit
